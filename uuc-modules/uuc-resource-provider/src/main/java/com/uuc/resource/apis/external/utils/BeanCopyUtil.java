package com.uuc.resource.apis.external.utils;

import com.uuc.common.core.exception.ServiceException;
import com.uuc.resource.apis.external.controller.VirtualMachineController;
    ...
    public static <T> void mergeObject(T origin, T destination) {
        ...
        for (int i = 0; i < fields.length; i++) {
            try {
                ...
                throw new ServiceException("bean复制异常:"+e.getMessage());
            }
        }
    }
