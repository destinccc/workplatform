...
import com.uuc.system.api.domain.SysDictData;
import com.uuc.system.service.ISysDictDataService;
...
import com.uuc.system.api.domain.SysDictType;
...
//    @RequiresPermissions("system:dict:list")
    @GetMapping("/listTypeAndData")
    public AjaxResult listTypeAndData(SysDictType dictType)
    {
        List<SysDictType> list = dictTypeService.listTypeAndData(dictType);
