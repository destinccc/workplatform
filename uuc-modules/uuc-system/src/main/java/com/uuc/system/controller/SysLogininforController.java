...
public class SysLogininforController extends BaseController
{
    ...
    @GetMapping("/getCurrentUserPrevLoginLog")
    public AjaxResult getCurrentUserPrevLoginLog()
    {
        return AjaxResult.success(logininforService.getCurrentUserPrevLoginLog());
    }
