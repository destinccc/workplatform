...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult listAllRoles()
    {
        ...
        role.setDelFlag("0");
        List<SysRole> list = roleService.selectRoleList(role);
        return AjaxResult.success(list.stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()));
    }
    ...
    public AjaxResult add(@Validated @RequestBody SysRole role)
    {
        ...
        //roleService.checkDefaultUnique(role);
     ...
     */
    @InnerAuth
    @GetMapping(value = "/getDefaultRole")
    public AjaxResult getDefaultRole()
    {
        return AjaxResult.success(roleService.getDefaultRole());
    }
