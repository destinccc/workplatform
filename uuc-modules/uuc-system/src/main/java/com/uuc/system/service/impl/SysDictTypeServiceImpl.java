...
import com.uuc.system.mapper.SysDictTypeMapper;
...
//    }
    ...
    public List<SysDictType> listTypeAndData(SysDictType dictType) {
        ...
        for (SysDictType type : dictTypeList) {
            String key = type.getDictType();
            List<SysDictData> dataChild = new ArrayList<>();
            for (SysDictData data : dictDataList) {
                if (key.equals(data.getDictType())) {
                    dataChild.add(data);
                }
            }
            type.setDictDataList(dataChild);
        }
        return dictTypeList;
    }
