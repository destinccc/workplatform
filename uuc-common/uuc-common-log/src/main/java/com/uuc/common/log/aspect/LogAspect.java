package com.uuc.common.log.aspect;
...
import com.uuc.common.log.enums.BusinessStatus;
import com.uuc.common.log.service.AsyncLogService;
...
public class LogAspect
{
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLog operLog, Object jsonResult) throws Exception
    {
        ...
        // 请求客户端客户端 网关没有就没有
        operLog.setClientId(SecurityUtils.getClientId());
        // 是否需要保存request，参数和值
