package com.uuc.common.datascope.aspect;
...
//        handleDataScope(point, controllerDataScope);
     ...
     */
    public static void dataScopeFilter(JoinPoint joinPoint, UucUserInfo user, String deptAlias, String userAlias)
    {
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            {
                sqlString.append(StringUtils.format(" OR {}.dept_id = {} ", deptAlias, user.getDeptCode()));
            }
            else if (DATA_SCOPE_DEPT_AND_CHILD.equals(dataScope))
            {
                sqlString.append(StringUtils.format(
                        " OR {}.dept_id IN ( SELECT dept_id FROM sys_dept WHERE dept_id = {} or find_in_set( {} , ancestors ) )",
                        deptAlias, user.getDeptCode(), user.getDeptCode()));
            }
